...
const Home: FC<PropTypes> = function (props) {
  ...
  return <main className={styles.home}>
    <section className={styles.banner}>
      <h2>{i18n.formatMessage({ id: 'home_banner_head1' })}<br />{i18n.formatMessage({ id: 'home_banner_head2' })}</h2>
    ...
    <section className={styles.products}>
      ...
      <ul>
        <li>
          ...
          <p>{i18n.formatMessage({ id: 'home_products_item_text_1_1' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_1_2' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_1_3' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_1_4' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_1_5' })}</p>
        </li>
        <li>
          <h5>{i18n.formatMessage({ id: 'home_products_item_head_2' })}</h5>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_2_1' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_2_2' })}</p>
        ...
        <li>
          ...
          <p>{i18n.formatMessage({ id: 'home_products_item_text_3_1' })}</p>
          <p>{i18n.formatMessage({ id: 'home_products_item_text_3_2' })}</p>
        </li>
      </ul>
    </section>

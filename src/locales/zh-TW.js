...
export default {
  ...
  how_assets_item_text_4_6: '等',
  how_sto_head: 'STO 給發行人和投資者帶來前所未有的好處',
  ...
  how_sto_item_head_6_2: ' ',
  how_sto_item_text_1: '財務顧問，法律顧問，稅務顧問，STO顧問，上市地點',
  how_sto_item_text_2: '智能合約上編碼的規則（例如銷售限制，市場情景）',
  how_sto_item_text_3: '自動股息/利息分配（取決於資產類型）​',
  how_sto_item_text_4: '不同司法管轄區的法律，稅務和會計問題​',
  how_sto_item_text_5: '向合格投資者發行的證券型代幣（T + 0即時結算）',
  how_sto_item_text_6: '24/7 市場准入',
  how_faq_head: 'FAQs',
  how_faq_iss_head: '發行人 / 保荐人',
  how_faq_iss_q_1: 'Atom 8 是否獲得牌照？',
  ...
  how_faq_iss_a_1: 'Atom 8 是為證券及期貨事務監察委員會(SFC)管制活動(RA)的持牌人和發行人提供服務的技術解決方案提供商。 我們不提供公司融資方面的建議，也不提供證券交易。',
  how_faq_iss_a_2: 'STO 為公司提供了一種在資本市場上籌集資金的替代方法。 與IPO相比， STO的要求和上市成本要低得多，這使早期/中端市場的公司能夠獲得資本。 通過資產代幣化，傳統上流動性較差的資產（例如房地產，古董或藝術品）可以獲得更多的流動性。',
  how_faq_iss_a_3: '需要。 目前，我們的服務範圍僅限於保荐人（SFC RA6）。',
  how_faq_iss_a_4: 'Atom 8 提供證券型代幣諮詢，創建，管理SaaS（軟件即服務）和電子錢包解決方案。 費用因服務和基礎資產類型而異。 請通過[電子郵件地址]與我們聯繫以獲取更多詳細信息。',
  how_faq_iss_a_5: '根據要代幣化的資產，監管機構和KYC流程等的特定要求，發行證券型代幣通常需要3到6個月的時間。',
  ...
  how_faq_inv_a_2_1_2: '通過資產代幣化實現部分所有權，投資者可以投資傳統上較難獲得的資產類別，例如私募股權/風險投資基金，外國資產，稀有商品（例如粉紅色鑽石，藝術品，NFT）。',
  how_faq_inv_a_2_2_1: '可信性',
  how_faq_inv_a_2_2_2: '區塊鏈架構可確保證券型代幣交易記錄的不變性和容錯性。 有了相應的安全協議，記錄幾乎是不可能被篡改的，從而為投資者提供了信心和信譽。',
  how_faq_inv_a_2_3_1: '企業行動效率',
  how_faq_inv_a_2_3_2: '通過實施智能合約，派息等公司行動可以自動執行。 可以提高效率，也可以降低相應的管理成本。',
  how_faq_inv_a_3_1_1: '密鑰管理',
  how_faq_inv_a_3_1_2: '在數字資產的世界，您的私鑰是加密資產所有權的唯一證明。 未能正確管理私鑰可能會導致投資價值的全部損失。',
  how_faq_inv_a_3_2_1: '服務提供商風險',
  how_faq_inv_a_3_2_2: '投資者需要交易所和保管人等各方的服務，以便交易證券型代幣。 如果這些服務提供商未能以可靠的方式交付其服務範圍，則投資者可能遭受重大損失。',
  ...
  how_faq_inv_a_4: '新發行的證券型代幣將存儲在HKbitEX（Atom 8的關聯公司）企業級數字資產託管中。 投資者可以通過在HKbitEX開立賬戶將其證券型代幣存儲在HKbitEX託管中。',
  how_faq_inv_a_5: '目前，香港證券代幣的二級交易受12個月鎖定期的限制。 您可能可以在場外交易或在許可的數字交易所進行交易。',
  how_faq_inv_a_6: '資本利得在香港不徵稅。 但是，如果出售構成一項具有貿易性質的交易，則出售資產的收益可能要繳納利得稅。',
  ...
  how_academy_sto_q_3: 'STO 與初始代幣發行(ICO)相同嗎？',
  how_academy_sto_q_4: 'STO 如何發揮作用？',
  how_academy_sto_q_5: '什麼是代幣化？',
  how_academy_sto_a_1: '證券型代幣是資產所有權（例如黃金，房地產）或經濟權利（例如利潤或收入的份額）的數字表示。 STO是籌集資金的一種形式，涉及向投資者提供或發行證券代幣。',
  how_academy_sto_a_2: '加密貨幣或更廣泛的加密資產和證券型代幣都歸類為數字資產（或可互換的虛擬資產）。 儘管目前尚無統一的全球分類法來定義加密資產，但證券型代幣已被明確定義並作為主要轄區的證券被廣泛監管。',
  how_academy_sto_a_3: '不會。由於證券型代幣作為證券的法律地位，除適用於發行證券型代幣或其他加密資產的任何最新法規外，適用於證券的通常更為繁瑣的監管制度通常也適用於STO。 相反，ICO的結構無需註冊或遵守證券法規和監管機構。',
  how_academy_sto_a_4: '對於不滿足上市要求或希望避免證券交易所上市費用的公司，STO提供了一種受規範的籌資方式。 STO中涉及的流程比IPO相對簡單，通常需要更短的時間才能推向市場。',
  how_academy_sto_a_5: '代幣化是基於現實世界資產發行區塊鏈代幣的過程。',
  how_academy_bc_head: '區塊鏈 101',
  how_academy_bc_q_1: '什麼是區塊鏈？',
  how_academy_bc_q_2: '什麼是智能合約？',
  how_academy_bc_q_3: '公鏈 vs 聯盟鏈',
  how_academy_bc_q_4: '區塊鏈如何發揮作用？',
  how_academy_bc_a_1: '區塊鍊是一種數據庫技術，可在無信任和分散的環境中實現跨多方的安全數據同步。 通過利用不同類型的區塊鏈（例如公鏈，聯盟鏈和私人區塊鏈），我們可以促進B2B或P2P生態系統內的協作和交易。 主要用例包括資金籌集（例如ICO，IEO和STO），供應鏈可追溯性和跨境支付。',
  how_academy_bc_a_2_1: '智能合約不是一份契約。 實際上，它們不過是嵌入了邏輯的計算機代碼而已。概念很簡單：在預訂情況發生時，事先設計的行動就會被觸發。',
  how_academy_bc_a_2_2: '證券型代幣交易可以使用智能合約來自動化公司操作，例如派息。',
  how_academy_bc_a_3_1: '公鏈允許任何一方加入生態系統。 它們旨在促進無信任環境中的去中心化。公鏈通常用於籌款和P2P支付，由於需要挖掘（共識機制），因此經常受到去中心化，安全和可擴展性三難的約束。公鏈例子：比特幣區塊鏈，以太坊',
  how_academy_bc_a_3_2: '許可或聯盟鏈僅允許經過驗證的用戶加入生態系統。 它們旨在促進實時，安全的B2B數據同步。 參與方需要身份確認流程以獲得數字簽名以加入平台。 無需挖掘，聯盟鏈的性能和吞吐量通常會更高。 這種技術通常用於公司解決方案中，用例包括貿易融資，銀行保險和了解您的客戶（KYC）。許可的區塊鏈例子：超級賬本，Corda R3',
  how_academy_bc_a_4_1: '區塊鍊或分佈式賬本技術在各種情況下開闢了新的機會。 它促進了不同生態系統內的協作和夥伴關係。',
  how_academy_bc_a_4_2: '除了加密資產和資金籌集之外，區塊鏈的最大用例是貿易融資。傳統上，由於重複融資問題，銀行通常不會向中小企業提供供應鏈融資。 但是現在，通過利用區塊鏈的加密元素，銀行可以更有信心地與新客戶打交道。 貿易金融區塊鏈的例子包括香港的eTradeconnect和歐洲的We.trade。',

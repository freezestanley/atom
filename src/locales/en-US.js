export default {
  ...
  how_sto_item_text_2: 'Rules (e.g. selling restrictions, market scenarios) coded on [b]smart contracts[/b]',
  how_sto_item_text_3: '[b]Automated dividend / interest distribution​[/b] (asset specific)',
  how_sto_item_text_4: 'Legal, tax and accounting issues in different jurisdictions​',
  how_sto_item_text_5: 'Security tokens issued to qualified investors [b](T+0 near-instant settlement)[/b]',
  ...
  how_faq_iss_q_6: 'Do I need to have an in-house blockchain team to issue security tokens?',
  how_faq_iss_q_7: 'Do I need a digital asset wallet to issue security tokens?',
  how_faq_iss_a_1: 'Atom 8 is a technology solution provider serving SFC Regulated Activities (RA) licensees and Issuers. We don’t advise on corporate finance nor deal in securities.',
  how_faq_iss_a_2: 'STO provides corporates with an alternative way to raise fund in capital markets. As compared to an IPO, the requirements of launching a STO and costs of listing are much lower, which empowers early-stage/ mid-market companies access capital. With asset tokenization, traditionally illiquid assets such as real estate, antiques or fine arts can gain much more liquidity.',
  how_faq_iss_a_3: 'Yes. Our service scope currently restricts to sponsors (SFC RA6).',
  how_faq_iss_a_4: 'Atom 8 provides Token Advisory, Token Creation, Token Management SaaS (software as a service) and Wallet solutions. The fee schedule varies across services and the underlying asset types. Please contact us at [email address] for further details.',
  how_faq_iss_a_5: 'Depending on the asset to be tokenized, specific requirements from the regulators and KYC process etc., it usually takes around 3 to 6 months to launch a security token.',
  how_faq_iss_a_6: 'In-house technical delivery capabilities are not required to issue security tokens.',
  how_faq_iss_a_7: 'A digital wallet is needed to store your security tokens after issuance. ',
  ...
  how_faq_inv_q_3: 'What are the risks associated with investing in Security Tokens? ',
  ...
  how_faq_inv_a_1: 'Yes. Security token is regulated as securities in Hong Kong under SFC. ',
  how_faq_inv_a_2_1_1: 'Accessibility',
  how_faq_inv_a_2_1_2: 'With fractional ownership enabled by asset tokenization, investors can gain access to traditionally less accessible asset classes like PE/VC funds, foreign properties, rare commodities (e.g. pink diamond, fine arts, NFT).',
  how_faq_inv_a_2_2_1: 'Credibility',
  how_faq_inv_a_2_2_2: 'The Blockchain architecture ensures immutability and fault-tolerance of trading records of Security Tokens. With corresponding security protocols in place, the records are virtually impossible to be tampered with which provides confidence and credibility to investors.',
  how_faq_inv_a_2_3_1: 'Efficiency in corporate actions',
  how_faq_inv_a_2_3_2: 'With the implementation of Smart Contracts, corporate actions like dividend pay-out can be automated. Efficiency can be enhanced and corresponding administrative costs can also be lowered.',
  how_faq_inv_a_3_1_1: 'Key Management',
  how_faq_inv_a_3_1_2: 'In the digital asset space, your private key is the only proof of ownership to your crypto-assets. Failing to manage private keys properly might result in total loss of value of investment.',
  how_faq_inv_a_3_2_1: 'Service provider risk',
  how_faq_inv_a_3_2_2: 'Investors require services from parties like exchanges and custodians in order to trade Security Tokens. Investors might suffer substantial losses if these service providers fail to deliver their scope of services in a reliable manner.',
  how_faq_inv_a_3_2_3: 'Example: https://slate.com/technology/2019/12/quadriga-gerald-cotten-death-cryptocurrency.html',
  how_faq_inv_a_3_3_1: 'Risk that also exist in conventional financial markets:',
  how_faq_inv_a_3_3_2: 'Volatility and liquidity',
  how_faq_inv_a_4: 'Newly issued security tokens will be stored at HKbitEX’s (Atom 8’s affiliate company) institutional-grade digital asset custody. Investors may store their security tokens in HKbitEX custody by opening an account with HKbitEX.',
  how_faq_inv_a_5: 'Secondary trading of security tokens in Hong Kong is currently subject to a 12-month lock-up period. You may be able to trade them OTC or on a licensed digital exchange.',
  how_faq_inv_a_6: 'Capital gains are not taxed in Hong Kong. However, gains on the disposal of assets may be subject to profits tax if the disposal constitutes a transaction in the nature of trade.',
  ...
  how_academy_sto_q_2: 'How are security tokens different from Cryptocurrencies?',
  ...
  how_academy_sto_a_1: 'Security tokens are digital representations of ownership of assets (e.g. gold, real estate) or economic rights (e.g. a share of profits or revenue). STOs are a form of fundraising involving the offering or issuance of security tokens to investors.',
  how_academy_sto_a_2: 'Cryptocurrencies, or more broadly cryptoassets, and security tokens are both categorized under the term digital assets (or interchangeably virtual assets). While there is currently no uniform global taxonomy for defining cryptoassets, security tokens are clearly defined and are widely regulated as securities under major jurisdictions.',
  how_academy_sto_a_3: 'No. Due to the legal status of security tokens as securities, the generally more onerous regulatory regimes applicable to securities will typically apply to STOs in addition to any more recent regulations specific to issuing tokens or other cryptoassets. In contrast, ICOs may be structured without the need to register or comply with securities regulations and regulatory bodies.',
  how_academy_sto_a_4: 'STO provides a regulated mean of fundraising for companies that do not meet listing requirements or would like to avoid listing fees on stock exchanges. The processes involved in a STO are relatively simpler than that of an IPO and usually take shorter time to roll out to the market.',
  how_academy_sto_a_5: 'Tokenization is the process of issuing a blockchain token based on real-world assets.',
  ...
  how_academy_bc_a_1: 'Blockchain is a database technology that enables secured data synchronization across multiple parties in trust-less and decentralized environments. By leveraging on different types of Blockchains (e.g. public, permissioned and private), we can facilitate collaboration and transaction within B2B or P2P ecosystems. Major use cases include fund raising (e.g. ICO, IEO and STO), supply chain traceability and cross-border payments.',
  how_academy_bc_a_2_1: 'There is a joke about Smart Contracts. They are neither smart nor contracts. In fact, they are nothing more than pieces of computer codes with logic embedded. The idea is simple: On the occurrence of predetermined actions, something else happens.',
  how_academy_bc_a_2_2: 'For the case of Security Token trading, smart contract can be used to automate corporate actions like dividend pay-outs.',
